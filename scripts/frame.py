...
outfile = geoscents_home + 'resources/databases/worldeasycities.js'
lonrng = [-180, 180]
latrng = [-65, 77]
...
outfile = geoscents_home + 'resources/databases/uscities.js'
lonrng = [-141, -43]
latrng = [12,54]
pop = 100000
...
outfile = geoscents_home + 'resources/databases/eurocities.js'
lonrng = [-36, 52]
latrng = [37,66]
pop = 100000
