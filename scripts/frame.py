...
make_country_list('Russia', [19, 190, 31.5, 79], 30000)
make_country_list('Ethiopia', [28, 53.85, 3, 18], 0)
make_country_list('Thailand', [87, 116.65, 5, 22], 0)
make_country_list('Tanzania', [24, 45, -12, 0.35], 0)
